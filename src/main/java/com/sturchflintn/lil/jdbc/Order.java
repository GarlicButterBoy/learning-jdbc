...
import com.sturchflintn.lil.jdbc.util.DataTransferObject;
...
public class Order implements DataTransferObject
{
    ...
    public String getCustomerLastLane() { return customerLastLane; }

    public void setCustomerLastLane(String customerLastLane) { this.customerLastLane = customerLastLane; }

    public String getCustomerEmail() { return customerEmail; }

    public void setCustomerEmail(String customerEmail) { this.customerEmail = customerEmail; }

    public Date getCreationData() { return creationData; }

    public void setCreationData(Date creationData) { this.creationData = creationData; }
